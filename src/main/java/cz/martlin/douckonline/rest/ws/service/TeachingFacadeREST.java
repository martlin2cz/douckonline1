 ...
 */
@Stateless
@Path("cz.martlin.douckonline.business.model.teaching.teaching")
public class TeachingFacadeREST extends AbstractFacade<Teaching> {
    ...
    public void create(Teaching entity) {
	super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Long id, Teaching entity) {
	super.edit(entity);
    }
    ...
    public Teaching find(@PathParam("id") Long id) {
