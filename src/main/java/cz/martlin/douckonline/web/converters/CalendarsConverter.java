 ...
 */
@RequestScoped
@Named("calendarsConverter")
public class CalendarsConverter implements Converter {

    public static final String DATE_FORMAT = "dd.MM.yy";    //TODO FIXME
	...
	try {
	    ...
	    throw new ConverterException("Cannot convert value to calendar", ex);
	}
	return cal;
    }
